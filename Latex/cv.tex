...
\newcommand{\skillbar}[1]{%
  \begin{tikzpicture}[x=0.1cm, y=0.2cm]
    \fill[lightgray] (0,0) rectangle (10,0.2);
    \fill[accentcolor] (0,0) rectangle (#1,0.2);
  \end{tikzpicture}%
}
...
% --- En-tête ---
\begin{center}
  \colorbox{maincolor}{\parbox{\dimexpr\textwidth-2\fboxsep\relax}{%
    \color{white}\centering
    {\Huge\bfseries PRÉNOM NOM\par}
    \vspace{4pt}
    {\Large\bfseries Poste actuel | Spécialisation\par}
  }}
\end{center}
...
\begin{minipage}[t]{0.3\textwidth}
  \raggedright
  \colorbox{sidecolor}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{%
    \color{white}
    \vspace{10pt}
    \begin{center}
      \includegraphics[width=3cm]{photo.jpg} % Photo circulaire
    \end{center}
    \vspace{10pt}

    % --- Informations ---
    \textbf{\large INFORMATIONS}\hrulefill\par
    \vspace{5pt}
    ...
    \vspace{10pt}
    % --- Compétences ---
    \textbf{\large COMPÉTENCES}\hrulefill\par
    \vspace{5pt}
    ...
    \vspace{10pt}
    % --- Langues ---
    \textbf{\large LANGUES}\hrulefill\par
    \vspace{5pt}
    ...
    \vspace{10pt}
    % --- Atouts ---
    \textbf{\large ATOUTS}\hrulefill\par
    \vspace{5pt}
...
\begin{minipage}[t]{0.68\textwidth}
  ...
  \hrule height 1pt width \hsize \color{accentcolor}\par
  \vspace{5pt}
  Professionnel motivé avec X années d'expérience dans [domaine]. Spécialisé dans [compétences clés]. Passionné par [centres d'intérêt].\par
  ...
  \begin{itemize}[nosep,leftmargin=*]
    \item Réalisation de [tâche principale 1] avec [résultat].
...
\textbf{Prénom NOM} \\
Poste actuel | Spécialisation en cybersécurité, RGPD, ISO 27001, NIS2, DORA \\
\textbf{Expérience Professionnelle} \\
\textbf{Poste occupé} chez Entreprise (MM/AAAA–Présent): [description]. \\
\textbf{Formation} \\
\textbf{Diplôme obtenu} à École (AAAA–AAAA). \\
\textbf{Compétences} \\
RGPD, ISO 27001, ISO 27002, ISO 27005, EBIOS RM, NIS2, DORA, CRA, Cybersécurité, Audit, Gestion des risques.
